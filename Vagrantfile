...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "ng1" do |ng1|
    ...
    ng1.vm.provision "shell", path: "https://gist.githubusercontent.com/abraunton/263a1796578ebc487af8/raw/7da0dced1083610bf3275a9fae3dca05bf0ae51a/provision-lb.sh"
  end
